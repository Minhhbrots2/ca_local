													...
													<div class="d-flex gap-1 align-items-center justify-content-between">
														<div class="fs-11 d-flex flex-wrap gap-1 align-items-center lst_action_crawl">
															<div class="d-flex align-items-center gap-1">
																...
																<button agency_id="{$_oItem.property_id}" type="button" class="btn btn-outline-primary btn-sm text-nowrap btn_crawl d-none" onClick="{if $clsISO->_DEV()}$Core.crawl.crawl_agency1(this,event){else}$Core.crawl.crawl_agency(this,event){/if}" project_id="" block_id="{$key}" stock_type="{$smarty.const._BLOCK_TYPE_HIGHLEVEL_SALE}">

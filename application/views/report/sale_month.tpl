						...
						<thead><tr>
							...
							<th class="p_header text-center text-upper" colspan="16">
								...
								<div class="mb-2">
									...
									<img class="w-px-50" src="{$clsConfiguration->getValue('LogoWhite')}" width="{$clsConfiguration->getImageWidth('LogoWhite')}" height="{$clsConfiguration->getImageHeight('LogoWhite')}" alt="{$header_configs.CompanyName}" />

					...
					<tr>
						<td>
							<a href="javascript:void(0);" onclick="$Core.member.view_profile(this, event)" profile_id="{$_p.profile_id}" class="d-flex align-items-center gap-2 text-decoration-none text-dark">
								<img class="rounded-pill" src="{$_p.avatar}" onerror="this.src='{$URL_IMAGES}/no-avatar.jpg'" width="34" height="34" alt="">
			...
			<table cellpadding="0" cellspacing="0" class="table table-sort table-bordered table_sortable rc-table">
				...
				<tbody>
					...
					<tr>
						...
						<td>{if $_u.leader_name}<a href="javascript:void(0);" onclick="$Core.member.view_profile(this, event)" profile_id="{$_u.head}" class="d-flex align-items-center gap-2 text-decoration-none text-dark"><img class="rounded-pill" src="{$_u.leader_avatar}" onerror="this.src='{$URL_IMAGES}/no-avatar.jpg'" width="30" height="30" alt=""><span class="fw-semibold text-truncate" style="max-width:130px" title="{$_u.leader_name}">{$_u.leader_name}</span></a>{else}<span class="text-muted">--</span>{/if}</td>

						...
						<div class="awe__post-item" order_no="{$_oNews.order_no}" id="post_item_{$news_id}">
							...
							<div class="awe__post-cmd">
								<div class="d-flex justify-content-center">
									...
									<a href="javascript:void(0);" class="awe__post-action flex-fill awe__post-share-action" data-link="{$_link}" data-title="{$_title}" data-toggle="modal" data-target="#sharer">

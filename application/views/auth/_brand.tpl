<div class="sky-auth__brand">
	...
	<div class="sky-auth__brand-body">
		...
		<p class="sky-auth__tagline">Hệ thống nội bộ dành cho cán bộ nhân viên <b>{$BRAND_NAME}</b> toàn quốc.</p>
	</div>
	<div class="sky-auth__foot">&copy; {$BRAND_NAME} &middot; Hệ thống nội bộ C-A</div>
</div>

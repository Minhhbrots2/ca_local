<?php
/* Smarty version 3.1.33, created on 2026-06-16 16:35:28
  from '/www/wwwroot/ca.futurehomes.vn/admin/application/views/permiss/default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a3118e0e22da5_33345717',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a74221dc13835d9bdcd08b74e0ac5594ce9b9a38' => 
    array (
      0 => '/www/wwwroot/ca.futurehomes.vn/admin/application/views/permiss/default.tpl',
      1 => 1781602527,
      2 => 'file',
    ),
  ),
...
function content_6a3118e0e22da5_33345717 (Smarty_Internal_Template $_smarty_tpl) {
...
&profile_type=user.fh" 
							class="filter-tab filter-tab-active show-all-items next-tab<?php if ($_smarty_tpl->tpl_vars['profile_type']->value == 'user.fh') {?> next-tab--is-active<?php }?>">User.FH</a>
					</li>
					<li class="filter-tab-item" data-tab-index="1">
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/index.php?mod=<?php echo $_smarty_tpl->tpl_vars['mod']->value;?>
&profile_type=MOC" 
							class="filter-tab filter-tab-active show-all-items next-tab <?php if ($_smarty_tpl->tpl_vars['profile_type']->value == 'MOC') {?> next-tab--is-active<?php }?>">MOC</a>
					</li>
					<li class="filter-tab-item" data-tab-index="1">
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/index.php?mod=<?php echo $_smarty_tpl->tpl_vars['mod']->value;?>
&profile_type=MF" 
							class="filter-tab filter-tab-active show-all-items next-tab <?php if ($_smarty_tpl->tpl_vars['profile_type']->value == 'MF') {?> next-tab--is-active<?php }?>">MF</a>
					</li>
				</ul>
			</div>

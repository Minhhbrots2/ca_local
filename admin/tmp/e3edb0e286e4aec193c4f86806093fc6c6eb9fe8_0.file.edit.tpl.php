<?php
/* Smarty version 3.1.33, created on 2026-03-12 14:02:34
  from '/home/fhgroupt/ca.futurehomes.vn/admin/application/views/project/edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_69b2650aa23441_29373247',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e3edb0e286e4aec193c4f86806093fc6c6eb9fe8' => 
    array (
      0 => '/home/fhgroupt/ca.futurehomes.vn/admin/application/views/project/edit.tpl',
      1 => 1773298951,
      2 => 'file',
    ),
  ),
...
function content_69b2650aa23441_29373247 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
" class="btn btn-default ui-breadcrumb">
			...
			<button type="button" onClick="$Core.project.open_setting_table_update(this, event)" data-project-id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
" class="btn btn-default ui-breadcrumb"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('cloud-upload mr-3');?>
<span class="ui-breadcrumb__item">Tạo bảng hàng thấp tầng</span></button>
		</div>
	</div>
		...
		<div class="form-row">
			<div class="col-md-8 col-xs-12">
				<div class="ui-layout__item">
					<div class="ui-card"><div class="ui-card__section">
						<div class="ui-type-container">
							<div class="form-group mb-2 form-row">
								<div class="col-md-4">
									<label class="col-form-label"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Code');?>
</label>
									<input type="text" class="form-control required" name="iso-code" value="<?php if ($_smarty_tpl->tpl_vars['pvalTable']->value > '0') {
echo $_smarty_tpl->tpl_vars['oneItem']->value['code'];
}?>" required maxlength="255" placeholder="Tên viết tắt dự án" />
								</div>
								<div class="col-md-4">
...
}?>" required maxlength="255" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Title');?>
" />
								</div>
								<div class="col-12 col-md-4">
									<label class="col-form-label">Tỉnh</label>
									<input type="text" class="form-control required" name="project_area" value="<?php if ($_smarty_tpl->tpl_vars['pvalTable']->value > '0') {
echo $_smarty_tpl->tpl_vars['more_information']->value['project_area'];
}?>" required maxlength="255" placeholder="Khu vực" />
								</div>
								<div class="col-12 col-md-4">
							...
							<div class="form-group form-row">
								...
								<input type="text" class="form-control required" name="address" value="<?php if ($_smarty_tpl->tpl_vars['pvalTable']->value > '0') {
echo $_smarty_tpl->tpl_vars['more_information']->value['address'];
}?>" required maxlength="255" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Address');?>
" />
							</div>
							...
							<div class="form-group form-row">
								<div class="col-md-6">
									...
									<input class="form-control" name="iso-link" value="<?php if (!empty($_smarty_tpl->tpl_vars['oneItem']->value['link'])) {
...
echo $_smarty_tpl->tpl_vars['clsClassTable']->value->getLink($_smarty_tpl->tpl_vars['pvalTable']->value);
								...
								<div class="col-md-6">
									...
									<input name="tiles_link" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['tiles_link'];?>
" maxlength="255" />
								</div>
							</div>
							<div class="form-group form-row">
...
" maxlength="255" />
								...
								<div class="col-md-6">
									...
									<input class="form-control" name="vr_source" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['vr_source'];?>
" maxlength="255" />
								</div>
							</div>
							<hr />
...
?>
											<option<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkInArray($_smarty_tpl->tpl_vars['_oI']->value['list_admins'],$_smarty_tpl->tpl_vars['_admin']->value['profile_id'])) {?> selected<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['_admin']->value['profile_id'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
							...
							<div class="form-group">
								...
								<textarea class="form-control" cols="255" rows="4" name="iso-intro"><?php if ($_smarty_tpl->tpl_vars['pvalTable']->value > '0') {
...
echo $_smarty_tpl->tpl_vars['oneItem']->value['content'];
							...
							<div class="form-group">
								<label class="col-form-label">Ghi chú bảng hàng</label>
								<textarea class="form-control" id="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getUniqid();?>
" cols="255" rows="2" name="notes"><?php if ($_smarty_tpl->tpl_vars['pvalTable']->value > '0') {
echo $_smarty_tpl->tpl_vars['more_information']->value['notes'];
}?></textarea>
								<div class="help-block">Ghi chú này sẽ hiển thị ra ngoài bảng hàng</div>
							</div>
							<div class="row">
								<?php
...
]" class="form-control<?php if ($_smarty_tpl->tpl_vars['field']->value == 'dg_price') {?> price-In numberonly<?php }?>" value="<?php if (!empty($_smarty_tpl->tpl_vars['more_information']->value[$_smarty_tpl->tpl_vars['field']->value])) {
					...
					<div class="ui-card"><div class="ui-card__section">
						<header class="ui-stack ui-stack--wrap mb-3">
							...
							<div class="ui-stack-item">
								<button type="button" class="btn btn-default" onClick="add_property(this, event)" _openFrom="_project" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
...
" class="tr_attrs">
										...
										<td class="text-left">
											<input class="form-control title_field_<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
" name="attrs[<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
][title]" placeholder="Nhập tiêu đề" type="text" />
										</td>
										<td class="text-left">
											<input class="form-control content_field_<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
" name="attrs[<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
...
" onClick="delete_property(this, event)"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('trash');?>
					...
					<!-- Section -->
					<div class="ui-card"><div class="ui-card__section d-none">
						<header class="ui-stack ui-stack--wrap mb-3">
							<h2 class="ui-stack-item ui-stack-item--fill ui-heading">1. Thuộc tính</h2>
							<div class="ui-stack-item">
								<button type="button" class="btn btn-default add_property" onClick="add_property(this, event)" _openFrom="_project" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
">+ Thêm</button>
							</div>
						</header>
						<div class="ui-type-container">
...
][id]" value="<?php echo $_smarty_tpl->tpl_vars['_Item']->value['id'];?>
" />
											<input type="hidden" name="properties[<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
][lock]" value="<?php echo $_smarty_tpl->tpl_vars['_Item']->value['lock'];?>
" />
											<input class="form-control title_field_<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
...
" name="properties[<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
											...
											placeholder="Nhập giá trị" value="<?php echo $_smarty_tpl->tpl_vars['_Item']->value['content'];?>
" type="text" />
										</td>
										<td class="text-center">
											<label class="switch">
												<input type="checkbox" name="properties[<?php echo $_smarty_tpl->tpl_vars['uid']->value;?>
][is_hot]" value="1"<?php if ($_smarty_tpl->tpl_vars['_Item']->value['is_hot'] == '1') {?> checked<?php }?>>
												<span class="slider round"></span>
											</label>
										</td>
										<td class="text-center">
...
" onClick="delete_property(this, event)"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('trash','Xóa');?>
					...
					<div class="ui-card d-none"><div class="ui-card__section">
						<header class="ui-stack ui-stack--wrap mb-3">
...
" banner_stock_id="" onClick="$Core.global.project.open_banner(this,event)">Thêm</button>
							</div>
						</header>
						<div class="ui-type-container">
...
?>
						...
						<div class="ui-card mt-half item_sop <?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
								...
								<div class="ui-stack d-flex align-items-center justify-content-between ui-stack--wrap">
									<div class="ui-stack-item">
										<div class="d-flex align-items-center gap-2">
											...
											<a href="javascript:void(0);" class="text-black btn btn-icon btn-xs btn-default" onclick="$Core.project.open_sop(this, event)" sop_id="<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
" data-toggle="tooltip" title="Nhấn lưu trước khi thay đổi"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('cog');?>
</a>
											<a href="javascript:void(0);" class="text-black btn btn-icon btn-xs btn-default" onclick="$Core.project.delete_sop(this)" sop_id="<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
" data-toggle="tooltip" title="Nhấn lưu trước khi thay đổi"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('trash');?>
</a>
											
											<a href="javascript:void(0);" onclick="$Core.project.move_sop(this, 'up')" class="text-black btn btn-icon btn-xs btn-default btn_moveup <?php if ((isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['first']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['first'] : null)) {?>d-none<?php }?>" sop_id="<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
" data-toggle="tooltip" title="Nhấn lưu trước khi thay đổi vị trí"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('arrow-up');?>
</a>
											<a href="javascript:void(0);" onclick="$Core.project.move_sop(this, 'down')" class="text-black btn btn-icon btn-xs btn-default btn_movedown <?php if ((isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['last']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['last'] : null)) {?>d-none<?php }?>" sop_id="<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
" data-toggle="tooltip" title="Nhấn lưu trước khi thay đổi vị trí"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('arrow-down');?>
</a>											
										</div>
									</div>
									<?php if ($_smarty_tpl->tpl_vars['_more_information']->value['field_type'] == '_list') {?>
									<div class="ui-stack-item">
										<button type="button" onClick="$Core.project.open_sop_item(this)" sop_item_id="0" sop_id="<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
...
][is_image]" value="1" <?php if ($_smarty_tpl->tpl_vars['_more_information']->value['is_image'] == '1') {?>checked<?php }?> id="checkbox_sop_is_image_<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" />
														<label for="checkbox_sop_is_image_<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
"> Cho phép hiển thị hình ảnh.</label>
													</div>
												</div>
												<div class="col-12 col-md-6">													
													<div class="icheck-primary">
														<input type="checkbox" name="sop[<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
][is_background]" value="1" <?php if ($_smarty_tpl->tpl_vars['_more_information']->value['is_background'] == '1') {?>checked<?php }?> id="checkbox_sop_is_background_<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" />
														<label for="checkbox_sop_is_background_<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
"> Đặt hình ảnh làm ảnh nền.</label>
													</div>
												</div>
											</div>
										</div>
...
][background_color]" value="<?php echo $_smarty_tpl->tpl_vars['_more_information']->value['background_color'];?>
">
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="col-form-label col-md-2 text-right"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Image');?>
</label>
										<div class="col-md-5">
											<div class="input-group">
												<input type="text" class="form-control" name="sop[<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
][image]" placeholder="Chọn hình ảnh làm icon" id="isoman_url_sop_image_<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['_more_information']->value['image'];?>
">
												<div class="input-group-btn">
													<button class="btn btn-default ajOpenDialog" isoman_for_id="sop_image_<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
...
" style="padding:9px 10px 9px"><?php echo $_smarty_tpl->tpl_vars['core']->value->makeIcon('image');?>
										...
										<div class="col-md-3">
											<select class="form-control" name="sop[<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
												...
												<option <?php if ($_smarty_tpl->tpl_vars['_more_information']->value['position'] == 'left') {?>selected<?php }?> value="left">Trái</option>
												<option <?php if ($_smarty_tpl->tpl_vars['_more_information']->value['position'] == 'right') {?>selected<?php }?> value="right">Phải</option>
												<option <?php if ($_smarty_tpl->tpl_vars['_more_information']->value['position'] == 'center') {?>selected<?php }?> value="center">Giữa</option>
											</select>
										</div>
									</div>
									<div class="form-group lines-bar">
										<label class="col-form-label col-md-2 text-right">Tiêu đề</label>
										<div class="col-md-10">
											<input type="text" class="form-control" name="sop[<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
][title_content]" value="<?php echo $_smarty_tpl->tpl_vars['_more_information']->value['title_content'];?>
">
										</div>
									</div>
									<div class="form-group lines-bar">
										...
										<div class="col-md-10">
											<textarea class="isoTextArea form-control" name="sop[<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
][content]" id="mce_sop_<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
" cols="255" rows="10"><?php echo $_smarty_tpl->tpl_vars['_more_information']->value['content'];?>
</textarea>
										</div>
									</div>
									<?php if ($_smarty_tpl->tpl_vars['_more_information']->value['field_type'] != '_textarea') {?>
										<div class="infobox">
											<b>Ghi chú</b><br />
											Mỗi một block sẽ bao gồm một danh sách các Item. Click <strong>Thêm mới</strong> để bắt đầu thêm mới.
										</div>									
										<div class="form-group lines-bar">
											<label class="col-form-label col-md-2 text-right">Tiêu đề danh sách</label>
											<div class="col-md-10">
												<input type="text" class="form-control" name="sop[<?php echo $_smarty_tpl->tpl_vars['_sop_Id']->value;?>
][title_list]" value="<?php echo $_smarty_tpl->tpl_vars['_more_information']->value['title_list'];?>
">
											</div>
										</div>
...
?>
					...
					<div class="d-flex align-items-center py-3">
						<button type="button" class="btn btn-default" onClick="$Core.project.open_sop(this, event)" sop_id="0" 
						project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
					...
					<div class="ui-card__section">
						<div class="form-group">
							<div class="custom-radio-wrapper core-radio-custom">
								<label class="">
									<input <?php if ($_smarty_tpl->tpl_vars['more_information']->value['project_has_block'] == '1' || !isset($_smarty_tpl->tpl_vars['more_information']->value['project_has_block']) || $_smarty_tpl->tpl_vars['pvalTable']->value == '0') {?> checked="checked"<?php }?> name="project_has_block" value="1" type="radio"> <span class="custom-radio custom-icon"></span>
								</label> Có phân khu
							</div>
						</div>
						<div class="form-group">
							<div class="custom-radio-wrapper core-radio-custom">
								<label class="">
									<input<?php if ($_smarty_tpl->tpl_vars['more_information']->value['project_has_block'] == '0' && $_smarty_tpl->tpl_vars['pvalTable']->value > '0') {?> checked="checked"<?php }?> name="project_has_block" value="0" type="radio"> <span class="custom-radio custom-icon"></span>
...
?>
							<div class="col-xs-6">
								<div class="form-group">
									<div class="checkbox">
										<input <?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkItemInArray($_smarty_tpl->tpl_vars['_oCat']->value['property_id'],$_smarty_tpl->tpl_vars['project_cat_menu']->value)) {?> checked="checked"<?php }?> name="project_cat_menu[]" value="<?php echo $_smarty_tpl->tpl_vars['_oCat']->value['property_id'];?>
...
" />
									<img class="aspect-ratio__content" id="isoman_show_logo" src="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['logo'];?>
">
								</div>
								<div class="clearfix"></div>
								<div class="ui-stack ui-stack--wrap">
									<div class="ui-stack-item ui-stack-item--fill">
										<button type="button" class="ui-button btn--link ajOpenDialog" isoman_for_id="logo" 
										isoman_val="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['logo'];?>
				...
				<div class="ui-card">
					...
					<div class="ui-card__section">
						<div class="ui-type-container">
							<div id="article-image-drop" class="article-image-drop">
								<div class="aspect-ratio aspect-ratio--square aspect-ratio--interactive">
									<input type="hidden" id="isoman_hidden_banner" name="isoman_url_banner" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['banner'];?>
" />
									<img class="aspect-ratio__content" id="isoman_show_banner" src="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['banner'];?>
">
								</div>
								<div class="clearfix"></div>
								<div class="ui-stack ui-stack--wrap">
									<div class="ui-stack-item ui-stack-item--fill">
										<button type="button" class="ui-button btn--link ajOpenDialog" isoman_for_id="banner" 
										isoman_val="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['banner'];?>
				...
				<div class="ui-card">
					...
					<div class="ui-card__section">
						<div class="ui-type-container">
							<div id="article-image-drop" class="article-image-drop">
								<div class="aspect-ratio aspect-ratio--square aspect-ratio--interactive">
									<input type="hidden" id="isoman_hidden_layout" name="isoman_url_layout" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['layout'];?>
" />
									<img class="aspect-ratio__content" id="isoman_show_layout" src="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['layout'];?>
">
								</div>
								<div class="clearfix"></div>
								<div class="ui-stack ui-stack--wrap">
									<div class="ui-stack-item ui-stack-item--fill">
										<button type="button" class="ui-button btn--link ajOpenDialog" isoman_for_id="layout" isoman_val="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['layout'];?>
					...
					<div class="ui-card__section">
						...
						<div class="form-row mb-2">
							<div class="col-xs-6">
								<div class="custom-radio-wrapper core-radio-custom">
									<label class="">
										<input <?php if ($_smarty_tpl->tpl_vars['more_information']->value['has_block'] == '1' || !isset($_smarty_tpl->tpl_vars['more_information']->value['has_block']) || $_smarty_tpl->tpl_vars['pvalTable']->value == '0') {?> checked="checked"<?php }?> name="has_block" value="1" type="radio"> <span class="custom-radio custom-icon"></span>
									</label> Có
								</div>
							</div>
							<div class="col-xs-6">
								<div class="custom-radio-wrapper core-radio-custom">
									<label class="">
										<input<?php if ($_smarty_tpl->tpl_vars['more_information']->value['has_block'] == '0' && $_smarty_tpl->tpl_vars['pvalTable']->value > '0') {?> checked="checked"<?php }?> 
										name="has_block" value="0" type="radio"> 
...
" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkItemInArray($_smarty_tpl->tpl_vars['key']->value,$_smarty_tpl->tpl_vars['more_information']->value['site_manager_ids'])) {?> checked="checked"<?php }?> />
					...
					<div class="ui-card__section">
						...
						<div class="form-row mb-2">
							<div class="col-xs-6">
								<div class="custom-radio-wrapper core-radio-custom">
									<label class="">
										<input<?php if (isset($_smarty_tpl->tpl_vars['more_information']->value['is_booking']) && $_smarty_tpl->tpl_vars['more_information']->value['is_booking'] == '1') {?> checked="checked"<?php }?> 
										name="is_booking" value="1" type="radio"> <span class="custom-radio custom-icon"></span>
									</label> Có
								</div>
							</div>
							<div class="col-xs-6">
								<div class="custom-radio-wrapper core-radio-custom">
									<label class="">
										<input<?php if (isset($_smarty_tpl->tpl_vars['more_information']->value['is_booking']) && $_smarty_tpl->tpl_vars['more_information']->value['is_booking'] == '0') {?> checked="checked"<?php }?> 
										name="is_booking" value="0" type="radio"> 
										<span class="custom-radio custom-icon"></span>
									</label> Không
								</div>
							</div>
...
" class="form-control" />
					...
					<div class="ui-card__section">
						...
						<div class="form-row">
							<div class="col-xs-6">
								<button class="btn btn-default w-100" onClick="$Core.project.open_config_column(this,event)" type="button" block_type="<?php echo @constant('_BLOCK_TYPE_HIGHLEVEL_SALE');?>
" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
" >Cao tầng</button>
							</div>
							<div class="col-xs-6">
								<button class="btn btn-default w-100" onClick="$Core.project.open_config_column(this,event)" type="button" block_type="<?php echo @constant('_BLOCK_TYPE_LOWFLOOR_SALE');?>
" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
">Thấp tầng</button>
							</div>
						</div>
				...
				<div class="ui-card"><div class="ui-card__section">
					<header class="ui-card__header d-flex align-items-center justify-content-between">
						...
						<div class="ui-stack-item">
							<button class="ui-button ui-button--link" onClick="open_block(this, event)" project_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>
" block_id="0">Thêm</button>
	...
	<div class="ui-page-actions ui-page-actions--has-secondary" style="position: sticky;bottom: 0;z-index: 1;background: #f4f6f8">
		<input value="Update" name="submit" type="hidden">
		<div class="ui-page-actions__container">
			<div class="ui-page-actions__actions ui-page-actions__actions--secondary">
				<div class="ui-page-actions__button-group">
					<?php if ($_smarty_tpl->tpl_vars['pvalTable']->value > '0') {?><a class="btn btn-warning" onClick="delete_globe(this)" clsTable="Slide" pval_id="<?php echo $_smarty_tpl->tpl_vars['pvalTable']->value;?>

<?php
/* Smarty version 3.1.33, created on 2026-01-30 10:46:00
  from '/home/fhgroupt/ca.futurehomes.vn/admin/application/views/stock/default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_697c2978974207_58587710',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f01baa1438ef33e21b7987100184b8b1a314e862' => 
    array (
      0 => '/home/fhgroupt/ca.futurehomes.vn/admin/application/views/stock/default.tpl',
      1 => 1769744754,
      2 => 'file',
    ),
  ),
...
function content_697c2978974207_58587710 (Smarty_Internal_Template $_smarty_tpl) {
...
" />
								<select class="form-control mr-2 gl-reload w-200px" name="project_id">
									<?php if ($_smarty_tpl->tpl_vars['stock_type']->value == @constant('_BLOCK_TYPE_LOWFLOOR_SALE')) {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
								...
								<?php if ($_smarty_tpl->tpl_vars['project_id']->value > '0') {?>
									<select class="form-control mr-2 gl-reload w-150px" name="block_id">
									...
									<?php if ($_smarty_tpl->tpl_vars['stock_type']->value == @constant('_BLOCK_TYPE_HIGHLEVEL_SALE')) {?>
										...
										<select class="form-control mr-2 w-150px gl-reload" id="slb_Building" name="building_id">
										...
										<select class="form-control custom-select w-150px gl-reload mr-2" name="floor">
...
&nbsp;</button>
									<div class="dropdown-menu mega-dropdown-menu py-3 px-2">
										...
										<div class="form-group mb-2">
											...
											<div class="col-xs-12 col-md-8">
												<select class="form-control custom-select" name="bedroom_id">
										...
										<div class="form-group mb-2">
											...
											<div class="col-xs-12 col-md-8">
												<select class="form-control custom-select" name="view_id">
										...
										<div class="form-group mb-2">
											...
											<div class="col-xs-12 col-md-8">
												<select class="form-control w-100 custom-select" name="home_direction_id">
										...
										<div class="form-group mb-2">
											...
											<div class="col-xs-12 col-md-8">
												<select class="form-control w-100 custom-select" name="agency_id">
										...
										<div class="form-group">
											...
											<div class="col-xs-12 col-md-8">
												<select class="form-control w-100 custom-select" name="status_id">
...
" onkeydown="do_stock_once_sold(this, event)" />
							...
							<div class="d-flex align-items-center admincp-buttons-action">
								<select class="form-control mr-1" name="per_page">

<?php
/* Smarty version 3.1.33, created on 2026-07-27 11:41:19
  from '/www/wwwroot/skyrealty.c-a.vn/admin/application/views/setting/profile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a66e16fb19a90_21553148',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3c6b76ba3811fd529f21c0cacdd92ee758b3260e' => 
    array (
      0 => '/www/wwwroot/skyrealty.c-a.vn/admin/application/views/setting/profile.tpl',
      1 => 1785127278,
      2 => 'file',
    ),
  ),
...
function content_6a66e16fb19a90_21553148 (Smarty_Internal_Template $_smarty_tpl) {
                    ...
                    <div class="cfg-row">
                        ...
                        <div class="cfg-row__control cfg-imgfield">
                            <div class="form-row flex-fill">
								<?php $_smarty_tpl->_assignInScope('confirm_billing', $_smarty_tpl->tpl_vars['clsISO']->value->to_array_json($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('confirm_billing')));?>
								<?php $_smarty_tpl->_assignInScope('gId', $_smarty_tpl->tpl_vars['clsISO']->value->getUniqId());?>
								<div class="col-12 col-md-6 col-lg-4">
									<select name="iso-confirm_billing[name]" class="form-control form-select" onChange="$Core.setting.loadStaffConfirm(this,event)" toId="<?php echo $_smarty_tpl->tpl_vars['gId']->value;?>
" >
										<option value="">Chọn đối tượng duyệt</option>
										<option value="admin" <?php if ($_smarty_tpl->tpl_vars['confirm_billing']->value['name'] == 'admin') {?>selected<?php }?> >Admin duyệt</option>
										<option value="project_manager" <?php if ($_smarty_tpl->tpl_vars['confirm_billing']->value['name'] == 'project_manager') {?>selected<?php }?> >Giám đốc dự án duyệt</option>
									</select>
								</div>
								<div class="col-12 col-md-6 col-lg-4">
									<select class="form-control <?php if ($_smarty_tpl->tpl_vars['confirm_billing']->value['name'] != 'admin') {?>d-none<?php }?>" name="iso-confirm_billing[staff_id]" id="<?php echo $_smarty_tpl->tpl_vars['gId']->value;?>
">
										<option value="">Chọn admin duyệt</option>
										<?php if (!empty($_smarty_tpl->tpl_vars['lstAdmin']->value)) {?>
											<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['lstAdmin']->value, '_oItem', false, 'key', 'i', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['_oItem']->value) {
?>
												<option value="<?php echo $_smarty_tpl->tpl_vars['_oItem']->value['profile_id'];?>
" <?php if ($_smarty_tpl->tpl_vars['confirm_billing']->value['staff_id'] == $_smarty_tpl->tpl_vars['_oItem']->value['profile_id']) {?>selected<?php }?> ><?php echo $_smarty_tpl->tpl_vars['_oItem']->value['full_name'];?>
</option>
											<?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            ...
                            <div class="form-row flex-fill">
								<div class="col-12 col-md-6 col-lg-6">
									<select class="w-100 form-select form-control iso-select2" multiple data-width="100%" name="iso-department_not_rankking[]" id="department_id">
										<?php echo $_smarty_tpl->tpl_vars['clsProperty']->value->getSelectByPropertyV2('_DEPARTMENT',$_smarty_tpl->tpl_vars['clsISO']->value->to_array_json($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('department_not_rankking')),'Phòng ban');?>

									</select>
								</div>
								<div class="col-12 col-md-6 col-lg-6">
									<select class="w-100 form-select form-control iso-select2" multiple data-width="100%" name="iso-role_not_rankking[]" id="role_id">
										<?php echo $_smarty_tpl->tpl_vars['clsProperty']->value->getSelectByPropertyV2('_ROLE',$_smarty_tpl->tpl_vars['clsISO']->value->to_array_json($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('role_not_rankking')),'Vai trò');?>
                ...
                <section class="cfg-card">
                    ...
                    <div class="cfg-row">
                        <label class="cfg-row__label"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Email Logo');?>
</label>
                        <div class="cfg-row__control cfg-imgfield">
                            <img class="isoman_img_pop" id="isoman_show_image" src="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('CompanyLogo');?>
" />
                            <input type="hidden" id="isoman_hidden_image" value="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('CompanyLogo');?>
">
                            <input class="cfg-input" type="text" id="isoman_url_image" name="iso-CompanyLogo" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('CompanyLogo'), ENT_QUOTES, 'UTF-8', true);?>
">
                            <a href="#" class="ajOpenDialog cfg-pick" isoman_for_id="image" isoman_val="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('CompanyLogo');?>
...
">
                            <input class="cfg-input" type="text" id="isoman_url_image_Fx" name="iso-HeaderLogo" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('HeaderLogo'), ENT_QUOTES, 'UTF-8', true);?>
">
                            <a href="#" class="ajOpenDialog cfg-pick" isoman_for_id="image_Fx" isoman_val="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('HeaderLogo');?>
" isoman_name="image"><img src="<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/general/folder-32.png" border="0" title="Open" alt="Open"></a>
                        </div>
                    </div>
                    <div class="cfg-row">
                        ...
                        <div class="cfg-row__control cfg-imgfield">
                            <img class="isoman_img_pop" id="isoman_show_image_Wht" src="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('LogoWhite');?>
" />
                            <input type="hidden" id="isoman_hidden_image_Wht" value="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('LogoWhite');?>
">
                            <input class="cfg-input" type="text" id="isoman_url_image_Wht" name="iso-LogoWhite" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('LogoWhite'), ENT_QUOTES, 'UTF-8', true);?>
">
                            <a href="#" class="ajOpenDialog cfg-pick" isoman_for_id="image_Wht" isoman_val="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('LogoWhite');?>
" isoman_name="image"><img src="<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/general/folder-32.png" border="0" title="Open" alt="Open"></a>
                        </div>
                    </div>
...
">
                    ...
                    <div class="cfg-row">
                        ...
                        <div class="cfg-row__control cfg-imgfield">
                            <img class="isoman_img_pop" id="isoman_show_image_Fx3" src="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('Favicon');?>
" />
                            <input type="hidden" id="isoman_hidden_image_Fx3" value="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('Favicon');?>
">
                            <input class="cfg-input" type="text" id="isoman_url_image_Fx3" name="iso-Favicon" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('Favicon'), ENT_QUOTES, 'UTF-8', true);?>
">
                            <a href="#" class="ajOpenDialog cfg-pick" isoman_for_id="image_Fx3" isoman_val="<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('Favicon');?>
" isoman_name="image"><img src="<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/general/folder-32.png" border="0" title="Open" alt="Open"></a>
                        </div>
                    </div>

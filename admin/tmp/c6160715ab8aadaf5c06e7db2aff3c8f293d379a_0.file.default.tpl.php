<?php
/* Smarty version 3.1.33, created on 2026-07-24 17:34:41
  from '/www/wwwroot/skyrealty.c-a.vn/admin/application/views/permiss/default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a633fc1b30f70_21459188',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c6160715ab8aadaf5c06e7db2aff3c8f293d379a' => 
    array (
      0 => '/www/wwwroot/skyrealty.c-a.vn/admin/application/views/permiss/default.tpl',
      1 => 1784889278,
      2 => 'file',
    ),
  ),
...
function content_6a633fc1b30f70_21459188 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="btn btn-success">+ Tạo</button>
									...
									<td class="text-center">
										<label class="switch" title="Hiển thị / Ẩn nhóm quyền">
											<input type="checkbox" tp="group" permiss_id="<?php echo $_smarty_tpl->tpl_vars['_oGroup']->value['permiss_id'];?>
"<?php if ($_smarty_tpl->tpl_vars['_oGroup']->value['is_active'] == '1') {?> checked<?php }?> onclick="$Core.permiss.toggle_permiss(this, event)">
...
.<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_k']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_k']->value['iteration'] : null);?>
										...
										<td class="text-center">
											<label class="switch" title="Hiển thị / Ẩn quyền">
												<input type="checkbox" tp="permiss" permiss_id="<?php echo $_smarty_tpl->tpl_vars['_oPermiss']->value['permiss_id'];?>

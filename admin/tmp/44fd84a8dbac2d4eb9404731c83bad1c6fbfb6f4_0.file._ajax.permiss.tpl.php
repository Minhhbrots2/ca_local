<?php
/* Smarty version 3.1.33, created on 2026-07-02 19:44:17
  from '/www/wwwroot/ca.futurehomes.vn/admin/application/views/member/_ajax.permiss.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a465d21937284_86116601',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '44fd84a8dbac2d4eb9404731c83bad1c6fbfb6f4' => 
    array (
      0 => '/www/wwwroot/ca.futurehomes.vn/admin/application/views/member/_ajax.permiss.tpl',
      1 => 1782374897,
      2 => 'file',
    ),
  ),
...
function content_6a465d21937284_86116601 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="modal-dialog modal-md">
	<form class="modal-content" method="POST">
		<div class="modal-header"> 
			<a href="javascript:void();" class="closeEv close_pop close"><span>×</span></a> 
			<h3 class="modal-title"><strong>Phân quyền <?php if ($_smarty_tpl->tpl_vars['source']->value == 'MF') {?>MF (myfuture.vn)<?php } else { ?>MOC (myoceancity)<?php }?></strong></h3>
		</div>
...
if ($_smarty_tpl->tpl_vars['_oItem']->value['is_default'] == 1) {?> <small class="text-muted" title="Mặc định của gói">(gói)</small><?php }?></span>
							</div>
						</div>
						<?php
}
...
" data-source="<?php echo $_smarty_tpl->tpl_vars['source']->value;?>
"

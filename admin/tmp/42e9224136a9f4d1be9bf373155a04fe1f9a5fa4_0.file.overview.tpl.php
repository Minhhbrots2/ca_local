...
/* Smarty version 3.1.33, created on 2026-07-27 18:58:34
  from '/www/wwwroot/skyrealty.c-a.vn/admin/application/views/project/overview.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a6747ea05bca9_96792142',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '42e9224136a9f4d1be9bf373155a04fe1f9a5fa4' => 
    array (
      0 => '/www/wwwroot/skyrealty.c-a.vn/admin/application/views/project/overview.tpl',
      1 => 1784549441,
      2 => 'file',
    ),
  ),
...
function content_6a6747ea05bca9_96792142 (Smarty_Internal_Template $_smarty_tpl) {
						...
						<div class="form-row" style="align-items:center">
							...
							<div class="col-md-5 text-right">
								<div class="d-flex justify-content-end gap-4 align-items-center">
									<div class="form-group w-200px mb-0">
										<select name="status_contract" id="" class="form-control form-select" onchange="$Core.project.saveStatusContract(this,event)" tp="Project" for_id="<?php echo $_smarty_tpl->tpl_vars['project_id']->value;?>
">
											<option value="">Chọn loại hợp đồng</option>
											<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['list_status_contract']->value, '_oItem', false, 'key', 'i', array (
));
if ($_from !== null) {
...
" <?php if ($_smarty_tpl->tpl_vars['_oItem']->value['property_id'] == $_smarty_tpl->tpl_vars['more_information']->value['status_contract']) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['_oItem']->value['property_code'];?>
</option>
											<?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
									...
									<label class="switch-inline d-flex align-items-center" style="margin-right:18px">
...
"<?php if ($_smarty_tpl->tpl_vars['oneItem']->value['is_lock'] == '1') {?> checked<?php }?>>
									...
									<label class="switch-inline d-flex align-items-center">

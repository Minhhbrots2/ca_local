<?php
/* Smarty version 3.1.33, created on 2026-06-27 11:30:11
  from '/www/wwwroot/ca.futurehomes.vn/admin/application/views/office/default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a3f51d309a117_23594495',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '37015c945c28f225fdf3ea88ccc2274ccc1fe7ad' => 
    array (
      0 => '/www/wwwroot/ca.futurehomes.vn/admin/application/views/office/default.tpl',
      1 => 1782533976,
      2 => 'file',
    ),
  ),
...
function content_6a3f51d309a117_23594495 (Smarty_Internal_Template $_smarty_tpl) {
...
/office.css?v=<?php echo $_smarty_tpl->tpl_vars['upd_version']->value;?>
" />
<?php echo '<script'; ?>
		...
		<div class="of-card" style="margin-bottom:16px">
			<div class="of-card-bd">
				...
				<div class="of-coordbar" style="align-items:flex-end">
					<div style="flex:1"><label class="of-fl">Giờ mở</label><input type="time" class="of-input" id="cfg_start" value="<?php echo $_smarty_tpl->tpl_vars['win_start']->value;?>
"></div>
					<div style="flex:1"><label class="of-fl">Giờ đóng (sau = vắng)</label><input type="time" class="of-input" id="cfg_end" value="<?php echo $_smarty_tpl->tpl_vars['win_end']->value;?>
"></div>
			...
			<div class="of-card">
				...
				<div class="of-card-bd">
					...
					<div class="of-global-note">
						<span>🕘</span>
						<div><b>Khung giờ check-in toàn hệ thống: <span id="of_window_label"><?php echo $_smarty_tpl->tpl_vars['checkin_window']->value;?>
</span></b> — Trong khung + trong vùng = điểm danh hợp lệ; ngoài vùng hoặc ngoài giờ = không cho.</div>
					</div>
...
<?php echo '<script'; ?>
 type="text/javascript">
	var OFFICE_DATA = <?php echo $_smarty_tpl->tpl_vars['offices_json']->value;?>
;
<?php echo '</script'; ?>
>
<?php }

<?php
/* Smarty version 3.1.33, created on 2025-10-31 14:26:09
  from '/home/fhgroupt/ca.futurehomes.vn/admin/application/views/permiss/default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_69046491f2c8d6_02057962',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '34a8c56a237f243f5c78a8dc1d337d98dd5c9330' => 
    array (
      0 => '/home/fhgroupt/ca.futurehomes.vn/admin/application/views/permiss/default.tpl',
      1 => 1730083834,
      2 => 'file',
    ),
  ),
...
function content_69046491f2c8d6_02057962 (Smarty_Internal_Template $_smarty_tpl) {
...
&profile_type=user.fh" class="filter-tab filter-tab-active show-all-items next-tab<?php if ($_smarty_tpl->tpl_vars['profile_type']->value == 'user.fh') {?> next-tab--is-active<?php }?>">User.FH</a>
					</li>
					<li class="filter-tab-item" data-tab-index="1">
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/index.php?mod=<?php echo $_smarty_tpl->tpl_vars['mod']->value;?>
&profile_type=MOC" class="filter-tab filter-tab-active show-all-items next-tab <?php if ($_smarty_tpl->tpl_vars['profile_type']->value == 'MOC') {?> next-tab--is-active<?php }?>">MOC</a>
					</li>
				</ul>
			</div>
						...
						<div class="freeze-table dragscroll" style="overflow-x: scroll; width:100%;">
							<table id="tableCall" cellspacing="0" class="table table-vertical table-striped" width="100%">
								<thead><tr>
									...
									<th width="100px" class="text-left">H.Động</th>
								</tr></thead>
								<?php

								...
								<tr>
									...
									<td class="text-center">
										<label class="switch" title="Hiển thị / Ẩn nhóm quyền">
											<input type="checkbox" tp="group" permiss_id="{$_oGroup.permiss_id}"{if $_oGroup.is_active eq '1'} checked{/if} 
									...
									<tr>
										...
										<td class="text-center">
											<label class="switch" title="Hiển thị / Ẩn quyền">
												<input type="checkbox" tp="permiss" permiss_id="{$_oPermiss.permiss_id}"{if $_oPermiss.is_active eq '1'} checked{/if} onclick="$Core.permiss.toggle_permiss(this, event)">
												<span class="slider round"></span>
											</label>
										</td>
										<td class="text-center">

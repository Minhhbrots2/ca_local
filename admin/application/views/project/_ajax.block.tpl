					...
					<div class="col-md-3">
						...
						<div class="d-flex gap-2 align-items-center">	
							<div class="form-group w-100 mb-0">
								<select name="status_contract" id="" class="form-control form-select iso-select2" onchange="$Core.project.saveStatusContract(this,event)" tp="Property" for_id="{$block_id}">

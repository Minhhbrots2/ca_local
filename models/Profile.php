...
class Profile extends dbBasic{
	...
	function sendEmailForgot($profile_id, $new_password){
		...
		if(trim($subject) === ''){
			$subject = 'Khôi phục mật khẩu - '.(defined('BRAND_NAME') ? BRAND_NAME : 'Sky Realty');
		}
		...
		$fromemail = defined('EMAIL_NOREPLY') ? EMAIL_NOREPLY : 'info@skyrealty.vn';
		$fromname = defined('BRAND_NAME') ? BRAND_NAME : 'Sky Realty';

...
class NotifyMOC extends dbBasic{
	...
	function sendEmailRequestPTG($member_id, $stock_code,$type=""){
		...
		$from_name = "Quản trị viên hệ thống MyOceanCity";

		$text_footer = "Cảm ơn Quý khách đã tin tưởng và sử dụng hệ thống của MyOceanCity. </br>

		Truy cập <a href='".DOMAIN_URL."'>SkyRealty.c-a.vn</a> để trải nghiệm các tính năng của hệ thống.";
		...
		$fromname = "My Ocean City";

		$fromemail = "info@myoceancity.vn";

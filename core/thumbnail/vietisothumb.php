...
class vietisothumb {
	...
	protected function processImageAndWriteToCache($localImage){
		...
		if(preg_match('/^image\/(?:png|webp)$/i', $mimeType) && !PNG_IS_TRANSPARENT && $canvas_trans){ 
	...
	protected function sendImageHeaders($mimeType, $dataSize){
		...
		if(in_array(strtolower($mimeType), array('image/wbp', 'wbp'))){
			$mimeType = 'image/webp';
		}
		...
		switch ($mimeType) {
			...
			case 'image/webp':
				if (function_exists('imagecreatefromwebp')) {
					...
					$this->error("GD Library Error: imagecreatefromwebp does not exist.");
					return false;
				}
				break;

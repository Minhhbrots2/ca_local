...
/** MF Database — kết nối CSDL thứ 2 (fhgroupt_mf) */
$dbconnMF =& ADONewConnection(DB_TYPE);
$dbconnMF->debug = ADODB_DEBUG;
$dbconnMF->Connect(MF_DB_HOST, MF_DB_USER, MF_DB_PASS, MF_DB_NAME);
$dbconnMF->setFetchMode(ADODB_FETCH_ASSOC);
$dbconnMF->Execute("SET time_zone='+7:00';");
/** Site Name */

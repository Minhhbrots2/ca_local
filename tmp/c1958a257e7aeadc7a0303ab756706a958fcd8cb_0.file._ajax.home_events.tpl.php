<?php
/* Smarty version 3.1.33, created on 2026-07-27 21:45:39
  from '/www/wwwroot/skyrealty.c-a.vn/application/views/home/course/_ajax.home_events.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a676f133a4d88_22155695',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c1958a257e7aeadc7a0303ab756706a958fcd8cb' => 
    array (
      0 => '/www/wwwroot/skyrealty.c-a.vn/application/views/home/course/_ajax.home_events.tpl',
      1 => 1783632300,
      2 => 'file',
    ),
  ),
...
function content_6a676f133a4d88_22155695 (Smarty_Internal_Template $_smarty_tpl) {
...
"><i class='bx bx-user-check'></i> Xác nhận</button>
							...
							<button type="button" openFrom="_desktop" toId="<?php echo $_smarty_tpl->tpl_vars['toId']->value;?>
" disabled class="btn btn-block btn-<?php if ($_smarty_tpl->tpl_vars['deviceType']->value == 'computer') {?>sm<?php } else { ?>xs<?php }?> btn-outline-warning"><i class="bx bx-user-check"></i> Check-In</button>
...
"><i class='bx bx-user-check'></i> Đã xác nhận</button>
							...
							<?php if (empty($_smarty_tpl->tpl_vars['oneEvent']->value['is_time_checkin'])) {?>
...
" disabled class="btn btn-block btn-<?php if ($_smarty_tpl->tpl_vars['deviceType']->value == 'computer') {?>sm<?php } else { ?>xs<?php }?> btn-outline-warning"><i class="bx bx-user-check"></i> Check-In</button>
							...
							<?php } else { ?>
								...
								<?php if ($_smarty_tpl->tpl_vars['oneEvent']->value['is_checked_in'] == '1') {?>

								<button type="button" class="btn btn-block btn-<?php if ($_smarty_tpl->tpl_vars['deviceType']->value == 'computer') {?>sm<?php } else { ?>xs<?php }?> btn-outline-success<?php if ($_smarty_tpl->tpl_vars['deviceType']->value != 'phone') {?> mt-2<?php } else { ?> ml-2<?php }?>"><i class="bx bx-check-double"></i> Đã check-In</button>
								...
								<form class="w-100" action="" method="POST" enctype="multipart/form-data">
									...
									<input type="file" class="d-none" id="upload_image_<?php echo $_smarty_tpl->tpl_vars['toId']->value;?>
" name="image" onChange="$Core.course.upload_image(this,event)" data-course_id="<?php echo $_smarty_tpl->tpl_vars['course_id']->value;?>
" 

									openFrom="_desktop" data-type="checkin">

									<button type="buton" onClick="$Core.course.select_image(this, event)" openFrom="_desktop" toId="<?php echo $_smarty_tpl->tpl_vars['toId']->value;?>
" class="btn btn-block btn-<?php if ($_smarty_tpl->tpl_vars['deviceType']->value == 'computer') {?>sm<?php } else { ?>xs<?php }?> btn-outline-warning">

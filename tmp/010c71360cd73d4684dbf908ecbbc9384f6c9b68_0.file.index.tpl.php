...
/* Smarty version 3.1.33, created on 2026-07-06 15:56:02
  from '/www/wwwroot/skyrealty.futureglobal.vn/application/blocks/chat/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a4b6da207a664_82082542',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '010c71360cd73d4684dbf908ecbbc9384f6c9b68' => 
    array (
      0 => '/www/wwwroot/skyrealty.futureglobal.vn/application/blocks/chat/index.tpl',
      1 => 1783314220,
      2 => 'file',
    ),
  ),
...
function content_6a4b6da207a664_82082542 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
>
	...
	<div class="fhc-panel" ng-class="{'fhc-open': c.open}">
		...
		<div class="fhc-head" ng-if="!(c.tab==='checkin' && c.ck.state==='journey')">
			...
			<img class="fhc-logo-img" src="{$URL_IMAGES}/logo-icon.png" alt="Future Homes" onerror="this.src='/application/themes/images/logo-icon.png'" />
			<div class="fhc-ti">
				<div class="fhc-t">{{(c.tab==='checkin' ? 'Future Way' : 'Chat nội bộ')}}</div>
			...
			<div ng-if="c.tab==='checkin'">
				...
				<div ng-if="!c.ck.loading && c.ck.my">
					...
					<div class="fhc-review" ng-if="c.ck.state==='review'">
						<div class="fhc-rvh">
							<span class="fhc-rvt">Thông tin check-in</span>
						...
						<div class="fhc-fld">
							...
							<div class="fhc-loc" ng-class="{ready: c.ck.address && !c.ck.geoErr, bad: c.ck.geoErr}">
								...
								<span class="fhc-loctxt">
									<span ng-if="c.ck.geoErr">{{ c.ck.geoErr }} <a class="fhc-rvlink" ng-click="c.ckRetryGeo()">Thử lại</a></span>
						...
						<button class="fhc-cta" type="button" ng-click="c.ckSubmit()" ng-disabled="!c.ck.address || c.ck.posting || c.ckNeedTagNote()">
							...
							{{ c.ck.posting ? 'Đang gửi…' : 'Hoàn tất check-in' }}
						</button>
					</div>
					<!-- Header info + tiến độ -->					
...
"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><rect x="7" y="11" width="3" height="6"/><rect x="12" y="7" width="3" height="10"/><rect x="17" y="13" width="3" height="4"/></svg> Báo cáo ngày</a>
	...
	<div class="fhc-srch" ng-if="c.srch.open && c.tab==='chat' && c.view==='thread'">
	...
	<div class="fhc-cg" ng-class="{'fhc-cg-addmode': c.cg.mode==='add'}" ng-show="c.cg.open">
	...
	<div class="fhc-rx" ng-show="c.rx.open" ng-click="c.closeReactors()">

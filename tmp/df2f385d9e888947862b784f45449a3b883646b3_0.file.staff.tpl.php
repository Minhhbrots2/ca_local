<?php
/* Smarty version 3.1.33, created on 2026-07-06 17:42:08
  from '/www/wwwroot/skyrealty.futureglobal.vn/application/views/member/staff.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a4b8680b77dd9_69923010',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'df2f385d9e888947862b784f45449a3b883646b3' => 
    array (
      0 => '/www/wwwroot/skyrealty.futureglobal.vn/application/views/member/staff.tpl',
      1 => 1783314317,
      2 => 'file',
    ),
  ),
...
function content_6a4b8680b77dd9_69923010 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
								...
								<div class="form-row mb-2">
									...
									<div class="col-6">
										...
										<select name="status_id" class="iso-select2" data-width="100%" 

										data-placeholder="Tình trạng" data-allow-clear="false">
			...
			<div class="table-container overflow-x-auto text-nowrap no-shadow">
				...
				<table cellpadding="0" cellspacing="0" class="table dragable table-staff table-striped table-borderd">
					...
					<thead><tr>
						...
						<th class="algin-center h-px-35 bg-lighter" width="3%">Mã NV</th><?php }?>
						...
						<th class="algin-center h-px-35 bg-lighter text-right">Doanh số</th>
						...
						<th class="algin-center h-px-35 bg-lighter text-left" width="40px"></th>
							...
							<td class="text-center">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" onClick="$Core.member.view_profile(this, event)" profile_id="<?php echo $_smarty_tpl->tpl_vars['_profile_id']->value;?>
" href="javascript:void(0);"><i class="bx bxs-show me-1"></i> Xem</a>
...
" href="javascript:void(0);"><i class="bx bx-refresh me-1"></i> Tính lại điểm Loyalty</a>
										<?php }?>

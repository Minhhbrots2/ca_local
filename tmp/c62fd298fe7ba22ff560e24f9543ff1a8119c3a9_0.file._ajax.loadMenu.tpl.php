<?php
/* Smarty version 3.1.33, created on 2026-07-07 14:09:18
  from '/www/wwwroot/skyrealty.futureglobal.vn/application/views/ajax/helper/_ajax.loadMenu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a4ca61e16e119_82042507',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c62fd298fe7ba22ff560e24f9543ff1a8119c3a9' => 
    array (
      0 => '/www/wwwroot/skyrealty.futureglobal.vn/application/views/ajax/helper/_ajax.loadMenu.tpl',
      1 => 1783314640,
      2 => 'file',
    ),
  ),
...
function content_6a4ca61e16e119_82042507 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<div style="position: absolute;
		...
		<a<?php if ($_smarty_tpl->tpl_vars['is_full_permis']->value == '1') {?> data-bs-toggle="modal" data-bs-target="#online-modal"<?php }?> 
			...
			class="text-dark badge fw-semibold text-fs-8 p-2 d-flex align-items-center gap-1 bg-white cursor-pointer">
	...
	<button type="button" data-toggle="ripple" class="btn btn-sm btn_config_menu bg-white fw-bold d-none" onClick="$Core.mobile.open_config_menu(this,event)" data-for="mb">Tùy chỉnh</button>
...
>
 ...
 text-main'></i>
					...
					<?php if ($_smarty_tpl->tpl_vars['_oUtilities']->value['badge'] == 'hot') {?><svg class="svg-icon position-absolute top-0 left-0" style="width:1.25em; height:1.25em;vertical-align:middle;fill:currentColor;overflow:hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M828.5 68.1H200.9c-57.8 0-104.6 44.4-104.6 99.3v694c0 13.7 2.9 26.8 8.3 38.7 22.3 49.9 83.9 68.2 130.5 39.7l244.7-149.6c28.1-17.2 63.5-16.6 91 1.4l221.1 145c59.3 38.9 139.4-1.8 141.3-72.7V167.3c-0.1-54.8-46.9-99.2-104.7-99.2z" fill="#187903" /><path d="M365.9 552.7h-32.7v-114H205.1v114.1h-32.7V299.6h32.7v110h128.1v-110h32.7v253.1zM414.9 429.2c0-40.9 11.1-73.4 33.2-97.6s52.1-36.3 89.9-36.3c35.2 0 63.5 11.8 85 35.5 21.5 23.6 32.2 54.4 32.2 92.3 0 41.1-11 73.7-33 97.7-22 24.1-51.4 36.1-88.3 36.1-36 0-64.8-11.8-86.5-35.5-21.6-23.5-32.5-54.3-32.5-92.2z m34.4-2.6c0 30.6 7.8 55.1 23.5 73.7 15.6 18.4 36 27.7 61.2 27.7 27 0 48.2-8.8 63.7-26.6 15.4-17.7 23.1-42.4 23.1-74.3 0-32.7-7.5-57.9-22.6-75.7-15.1-17.8-35.8-26.6-62-26.6-25.8 0-46.7 9.4-62.8 28.1-16.1 18.7-24.1 43.3-24.1 73.7zM857 328.7h-73v224.1h-32.9V328.7h-72.7v-29.1H857v29.1z" fill="#FFFFFF" /></svg><?php }?>

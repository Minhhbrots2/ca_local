<?php
/* Smarty version 3.1.33, created on 2026-07-27 21:57:06
  from '/www/wwwroot/skyrealty.c-a.vn/application/views/home/_ajax.billing.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a6771c2233d17_82409297',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6bced9143d9507ed943818609187a544c1de0deb' => 
    array (
      0 => '/www/wwwroot/skyrealty.c-a.vn/application/views/home/_ajax.billing.tpl',
      1 => 1785152901,
      2 => 'file',
    ),
  ),
...
function content_6a6771c2233d17_82409297 (Smarty_Internal_Template $_smarty_tpl) {
...
" selected="selected">
				...
				<div class="col-6 col-md-4">
					<label class="form-label mb-1">Bán cho</label>
					<select class="form-control form-select required" name="sold_to_type">
						<option value="0">Lựa chọn</option>
						<?php echo $_smarty_tpl->tpl_vars['clsProperty']->value->getSelectByProperty('SALE_TYPE',$_smarty_tpl->tpl_vars['oneBilling']->value['sold_to_type']);?>
...
echo $_smarty_tpl->tpl_vars['more_information']->value['customer_email'];
			...
			<div class="form-row mb-2">
				<div class="col-12 col-md-3 mb-2 mb-lg-0">
					...
					<select class="form-control form-select" name="deal_type" title="Nội bộ ăn TPKD/GĐKD, PTĐT ăn CV/TP/GĐ PTĐT">
						<option value="sale"<?php if ($_smarty_tpl->tpl_vars['more_information']->value['deal_type'] != 'ptdt') {?> selected<?php }?>>Sale nội bộ</option>
						<option value="ptdt"<?php if ($_smarty_tpl->tpl_vars['more_information']->value['deal_type'] == 'ptdt') {?> selected<?php }?>>Phát triển đối tác (PTĐT)</option>
					</select>
				</div>
				<div class="col-12 col-md-3 mb-2 mb-lg-0">
					<label class="form-label mb-1">Sales bán</label>
					<select class="required w-100<?php if ($_smarty_tpl->tpl_vars['action']->value == '_add') {?> iso-selectizeImageSearch<?php } else { ?> iso-selectize<?php }?>" placeholder="Chọn sales bán" name="staff_id" data-optgroup="false"
						onChange="$Core.billing.handle_staff_changed(this, event)" data-url="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/index.php?mod=home&act=list_staff&holderG=all">
						<?php if ($_smarty_tpl->tpl_vars['action']->value == '_edit') {?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['oneBilling']->value['staff_id'];?>
" selected><?php echo $_smarty_tpl->tpl_vars['clsProfile']->value->getIndentity($_smarty_tpl->tpl_vars['oneBilling']->value['staff_id']);?>
</option>
						<?php }?>
					</select>
				</div>

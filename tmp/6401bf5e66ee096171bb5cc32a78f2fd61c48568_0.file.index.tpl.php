<?php
/* Smarty version 3.1.33, created on 2026-07-07 11:44:32
  from '/www/wwwroot/skyrealty.futureglobal.vn/application/blocks/menu/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a4c84304e4b49_12546816',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6401bf5e66ee096171bb5cc32a78f2fd61c48568' => 
    array (
      0 => '/www/wwwroot/skyrealty.futureglobal.vn/application/blocks/menu/index.tpl',
      1 => 1783399470,
      2 => 'file',
    ),
  ),
...
function content_6a4c84304e4b49_12546816 (Smarty_Internal_Template $_smarty_tpl) {
...
" title="Kho tài liệu" class="menu-link" data-toggle="ripple">
				...
				<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'document') {?> active<?php }?>">
					<a href="/van-ban-he-thong.html" class="menu-link" data-toggle="ripple">
						<i class='menu-icon tf-icons bx bx-file'></i>
						<div class="text-truncate" data-i18n="Basic">Văn bản tài liệu</div>
					</a>
				</li>	
...
/lich-phong-hop.html" class="menu-link" data-toggle="ripple">
		...
		<!--		=========================-->
		<!--		=============Kế toán============-->		
		<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('fund_access') || $_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('salary_access')) {?>	
			<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'data_central') {?> active<?php }?>">
				<?php $_smarty_tpl->_assignInScope('gId', $_smarty_tpl->tpl_vars['clsISO']->value->getUniqid());?>
				<a data-toggle="ripple" href="javascript:void(0);" class="menu-link w-100 d-block menu-toggle mx-0 text-left">
					<i class="menu-icon tf-icons bx bx-calculator text-main"></i>
					<span class="menu-header-text text-upper text-main fs-11 fw-semibold">Kế toán (<span id="<?php echo $_smarty_tpl->tpl_vars['gId']->value;?>
" >0</span>)</span>
				</a>
				<ul class="menu-sub no-before" toId="<?php echo $_smarty_tpl->tpl_vars['gId']->value;?>
">
					<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('DIRECTOR') || $_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('ACCOUNTANT')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'acc' && $_smarty_tpl->tpl_vars['sub']->value == 'report') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getLink('finance');?>
" class="menu-link" data-toggle="ripple">
					...
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('DIRECTOR') || $_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('salary_access')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'tool' && $_smarty_tpl->tpl_vars['act']->value == 'salary') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getLink('salary');?>
" class="menu-link" data-toggle="ripple">
					...
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('fund_access')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'fund' && ($_smarty_tpl->tpl_vars['act']->value == 'ops_cost' || $_smarty_tpl->tpl_vars['act']->value == 'opscost_dashboard')) {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getLink('operation_fee');?>
" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-cog"></i>
								<div class="text-truncate" data-i18n="Chi phí vận hành">Chi phí vận hành</div>
							</a>
						</li>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'fund' && ($_smarty_tpl->tpl_vars['sub']->value == 'cash_book')) {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getLink('cash_book');?>
" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-money"></i>
								<div class="text-truncate" data-i18n="Chi phí vận hành">Quỹ tiền mặt</div>
							</a>
						</li>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'fund' && $_smarty_tpl->tpl_vars['sub']->value == 'default' && $_smarty_tpl->tpl_vars['act']->value == 'default') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/fund.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-wallet"></i>
								<div class="text-truncate" data-i18n="Thu chi nội bộ">Thu chi nội bộ</div>
							</a>
						</li>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'acc' && $_smarty_tpl->tpl_vars['sub']->value == 'vat') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/vat.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-shape-circle"></i>
								<div class="text-truncate" data-i18n="VAT đã xuất">VAT đã xuất</div>
							</a>
						</li>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'acc' && $_smarty_tpl->tpl_vars['sub']->value == 'commission') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/commission.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-receipt"></i>
								<div class="text-truncate" data-i18n="Hoa hồng bán mới">Hoa hồng môi giới</div>
							</a>
						</li>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'fund' && $_smarty_tpl->tpl_vars['act']->value == 'report') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/fund/report.html" class="menu-link" data-toggle="ripple">
...
//member/report.html" class="menu-link" data-toggle="ripple">
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('report_crm')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'crm' && $_smarty_tpl->tpl_vars['sub']->value == 'default' && $_smarty_tpl->tpl_vars['act']->value == 'report') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/crm/report.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-user-pin"></i>
...
">Hoạt động tiếp khách</div>
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('report_group')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'report_group') {?> active<?php }?>"> 
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/report/report_group.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-trophy"></i>
								<div data-i18n="Báo cáo CLB NS">Câu lạc bộ NS</div>
							</a>
						</li>
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermissMs()) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'worktime') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/report/worktime.html" class="menu-link" data-toggle="ripple">
...
">Vắng mặt</div>
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('DIRECTOR')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'loyalty') {?> active<?php }?>">
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/loyalty.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-star"></i>
								<div data-i18n="<?php echo $_smarty_tpl->tpl_vars['_oProject']->value['title'];?>
">Thống kê điểm loyalty</div>
							</a>
						</li>
...
/bao-cao.html" class="menu-link" data-toggle="ripple">
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('top_ten_sales')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'top_10') {?> active<?php }?>"> 
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/report/top-10.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-crown"></i>
								<div data-i18n="Báo cáo MOC">Top 10 sale</div>
							</a>
						</li><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('sales_has_trans')) {?>
						<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'sales_has_trans') {?> active<?php }?>"> 
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/report/sales-has-trans.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-check-square"></i>
								<div data-i18n="Sale đã có GD">Sale đã có GD</div>
							</a>
						</li><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('sales_not_trans')) {?>
							<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'top_sales') {?> active<?php }?>"> 
								<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/report/sale-no-trans.html" class="menu-link" data-toggle="ripple">
...
/bao-cao-dang-nhap.html" class="menu-link" data-toggle="ripple">
						...
						<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['sub']->value == 'project') {?> active<?php }?>"> 
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/tinh-trang-thong-tin-du-an.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-info-circle"></i>
								<div data-i18n="Tình trạng thông tin dự án">Tình trạng thông tin DA</div>
							</a>
						</li>
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('marketing_access') || $_smarty_tpl->tpl_vars['clsISO']->value->checkDEV()) {?>
						<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'marketing') {?> active<?php }?>"> 
							<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/marketing.html" class="menu-link" data-toggle="ripple">
								<i class="menu-icon tf-icons bx bx-money"></i>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'home' && $_smarty_tpl->tpl_vars['act']->value == 'today') {?> active<?php }?>">
		...
		<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('BO') && $_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('DIRECTOR') && 1 == 2) {?>
		<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'overtime' && $_smarty_tpl->tpl_vars['act']->value == 'default') {?> active<?php }?>">
			<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/overtime.html" class="menu-link" data-toggle="ripple">
...
/logs-sale.html" class="menu-link" data-toggle="ripple">
				...
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('log_search_all')) {?>
...
/logs-search.html" class="menu-link" data-toggle="ripple">
				...
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission("add_page_helper")) {?>
					<li class="menu-item">
						<a href="javascript:void(0)" class="menu-link" data-toggle="ripple" onClick="$Core.helper.edit_helper(this,event)" action="_OPEN" mod_page="<?php echo $_smarty_tpl->tpl_vars['mod']->value;?>
...
" title="Chỉnh sửa hướng dẫn">
				...
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('DIRECTOR')) {?>
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'home' && $_smarty_tpl->tpl_vars['act']->value == 'share' && $_smarty_tpl->tpl_vars['share_type']->value == 'secret') {?> active<?php }?>">
...
" class="menu-link">
				...
				<?php }?>
				<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['sub']->value == 'project' && $_smarty_tpl->tpl_vars['act']->value == 'report_stock_highfloor') {?> active<?php }?>">
					<a data-toggle="ripple" href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/tong-quan-gia-cao-tang.html" class="menu-link text-main fw-bold">
						<i class="menu-icon tf-icons bx bx-table"></i>
						<div class="text-truncate" data-i18n="Bảng giá /m2">Bảng giá /m<sup>2</sup></div>
					</a>
				</li>
				<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['sub']->value == 'project' && $_smarty_tpl->tpl_vars['act']->value == 'report_stock_lowfloor') {?> active<?php }?>">
					<a data-toggle="ripple" href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/tong-quan-gia-thap-tang.html" class="menu-link text-info fw-bold">
						<i class="menu-icon tf-icons bx bx-table"></i>
						<div class="text-truncate" data-i18n="Bảng hàng dự án">T.Quan giá thấp tầng</div>
					</a>
				</li>
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->_DEV()) {?>
					<li class="menu-item d-none <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'client') {?> active<?php }?>">
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/xac-nhan-hoa-hong.html" class="menu-link" data-toggle="ripple">
					...
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'client') {?> active<?php }?>">
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/quan-ly-khach-hang.html" class="js-ripple menu-link">
				...
				<?php }?>			
				<?php if ($_smarty_tpl->tpl_vars['deviceType']->value == 'phone' && $_smarty_tpl->tpl_vars['clsISO']->value->_DEV()) {?>
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'home' && $_smarty_tpl->tpl_vars['act']->value == 'ultilities') {?> active<?php }?>">
				...
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission("data_central") && $_smarty_tpl->tpl_vars['clsISO']->value->_DEV()) {?>
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'data_central') {?> open active<?php }?>">
						<a data-toggle="ripple" href="javascript:void(0);" class="menu-link menu-toggle">
							<i class='menu-icon tf-icons bx bx-data'></i>
							<div class="text-truncate" data-i18n="Basic">Data Cư dân VHOP</div>
						</a>
						<ul class="menu-sub">
							<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'data_central' && $_smarty_tpl->tpl_vars['act']->value == 'default') {?> active<?php }?>">
								<a href="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getLink('data_central');?>
" class="menu-link mx-1" data-toggle="ripple">
									<div class="text-truncate" data-i18n="Basic">Danh sách data</div>
								</a>
							</li>
							<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'data_central' && $_smarty_tpl->tpl_vars['act']->value == 'campaign') {?> active<?php }?>">
								<a href="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getLink('campaign_data');?>
" class="menu-link mx-1" data-toggle="ripple">
				...
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkDEV() && 1 == 2) {?>
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'training' && $_smarty_tpl->tpl_vars['act']->value == 'inspire') {?> active<?php }?>">
						<a href="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getLink('inspire');?>
" class="menu-link" data-toggle="ripple">
...
/cho-thue.html" class="menu-link" data-toggle="ripple">
				...
				<?php }?>
				<?php }?> -->
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('report_billing')) {?>
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'billing' && $_smarty_tpl->tpl_vars['report_type']->value == 'common') {?> active<?php }?>">
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/billing/report.html" class="menu-link" data-toggle="ripple">
							<i class="menu-icon tf-icons bx bx-doughnut-chart"></i>
							<div class="text-truncate" data-i18n="Basic">Báo cáo bán hàng</div>
						</a>
					</li>
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['act']->value == 'billing' && $_smarty_tpl->tpl_vars['report_type']->value == 'mwf') {?> active<?php }?>">
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/billing/report/mwf.html" class="menu-link" data-toggle="ripple">
							<i class="menu-icon tf-icons bx bx-pie-chart-alt-2"></i>
							<div class="text-truncate" data-i18n="Basic">Báo cáo quỹ F1</div>
						</a>
					</li>
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->checkPermission('okrs_access') && 1 == 2) {?>
					<li class="menu-header small text-uppercase">
						<span class="menu-header-text">OKRs</span>
					</li>
					<li class="menu-item<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'okrs' && $_smarty_tpl->tpl_vars['act']->value == 'default') {?> active<?php }?>">
...
/login-history.html" class="menu-link" data-toggle="ripple">
				...
				<?php }?>
				<?php if (($_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('ADMIN_PROJECT') || $_smarty_tpl->tpl_vars['clsISO']->value->checkPermissionGroup('PROJECT_DIRECTOR')) && $_smarty_tpl->tpl_vars['clsISO']->value->_DEV()) {?>
					<li class="menu-item <?php if ($_smarty_tpl->tpl_vars['mod']->value == 'report' && $_smarty_tpl->tpl_vars['sub']->value == 'default' && $_smarty_tpl->tpl_vars['act']->value == 'report_price_stock') {?> active<?php }?>"> 
						<a href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/log-thay-doi-gia.html" class="menu-link" data-toggle="ripple">

...
/* Smarty version 3.1.33, created on 2026-07-06 15:56:02
  from '/www/wwwroot/skyrealty.futureglobal.vn/application/views/_footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a4b6da20438b6_51367843',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a6f0fd75a55f19249d301b22a80177a58c246b75' => 
    array (
      0 => '/www/wwwroot/skyrealty.futureglobal.vn/application/views/_footer.tpl',
      1 => 1783314203,
      2 => 'file',
    ),
  ),
...
function content_6a4b6da20438b6_51367843 (Smarty_Internal_Template $_smarty_tpl) {
...
" />
		...
		<?php }?>
		<?php if (!empty($_smarty_tpl->tpl_vars['is_show_pop_spin']->value)) {?>
		<div class="modal fade modal-auto-open" id="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getUniqid();?>
" tabindex="-1" aria-modal="true" role="dialog"> 
			<?php $_smarty_tpl->_assignInScope('_more_information', $_smarty_tpl->tpl_vars['oneProfile']->value['more_information']);?>
			<div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 700px">
				<div class="modal-content" style="background: #FFF0;border-radius: 15px;overflow: hidden;">
					<div class="modal-header p-0">
						<button type="button" data-bs-dismiss="modal" aria-label="Close" class="btn btn-icon closeEv zindex-1 rounded-pill text-white position-absolute" style="background: #ffffff26;box-shadow: 0 0 3px #FFF;right: 10px;top: 10px"><i class='bx bx-x' ></i></button> 
					</div>
					<div class="modal-body p-0 overflow-hidden">
						<a onClick="$Core.global.open_gift_box(this, event)">
							<img src="<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/spin-20-10.jpg" class="w-100" width="480" alt="">
						</a>
					</div>
					<button class="gift-btn2 position-absolute btn-lg" style="bottom: 75px;left: calc(50% - 90px)">🎁 Nhận quà ngay</button>
				</div>
			</div>
		</div>
		<?php }?>
...
echo $_smarty_tpl->tpl_vars['core']->value->getBlock('chat2');?>

<?php } else {
echo $_smarty_tpl->tpl_vars['core']->value->getBlock('chat');?>

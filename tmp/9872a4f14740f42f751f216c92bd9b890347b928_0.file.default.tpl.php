<?php
/* Smarty version 3.1.33, created on 2026-07-06 16:24:14
  from '/www/wwwroot/skyrealty.futureglobal.vn/application/views/worldcup/default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a4b743ef2a330_27057805',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9872a4f14740f42f751f216c92bd9b890347b928' => 
    array (
      0 => '/www/wwwroot/skyrealty.futureglobal.vn/application/views/worldcup/default.tpl',
      1 => 1783314332,
      2 => 'file',
    ),
  ),
...
function content_6a4b743ef2a330_27057805 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="worldcup_page" ng-app="wcApp">	
	<div class="main-content" ng-controller="MainCtrl as app" ng-cloak>
		<div class="container-xxl">
			<?php echo '<script'; ?>
>window.WC_BOOT = <?php echo json_encode($_smarty_tpl->tpl_vars['wc_boot']->value);?>
;<?php echo '</script'; ?>
>
						...
						<div class="podium">
							<div class="stand">
								<div class="slot" ng-repeat="u in app.podiumOrder">
									<div class="av" ng-style="{borderColor: app.medal[u.rank-1]}" ><img ng-src="{{u.avt}}" onerror="this.src='<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/no-avatar.jpg'" alt="" width="54" height="54" class="avatar w-100 h-100 img-cover rounded-pill"></div>
									...
									<tr class="lb-row" ng-class="{me: u.me}" ng-repeat="u in app.lbRest">
										...
										<td class="who">
											<div class="d-flex align-items-center">
												<span class="ava" ng-if="u.avt"><img ng-src="{{u.avt}}" onerror="this.src='<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/no-avatar.jpg'" alt="" width="30" height="30" class="avatar w-100 h-100 img-cover rounded-pill"></span><span class="name">{{u.name || '--'}}</span><span class="tag-me" ng-if="u.me">Bạn</span>
											</div>
										</td>
								...
								<div class="podium">
									<div class="stand">
										<div class="slot" ng-repeat="u in app.lbGhost.podium">
											<div class="av" ng-style="{borderColor: app.medal[u.rank-1]}"><img src="{{u.avt}}"  onerror="this.src='<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/no-avatar.jpg'" alt="" width="54" height="54" class="avatar w-100 h-100 img-cover rounded-pill"></div>
											<div class="nm">{{u.name}}</div>
										...
										<tbody>
											<tr class="lb-row" ng-repeat="u in app.lbGhost.rest">
												...
												<td class="who">
													<div class="d-flex align-items-center">
														<span class="ava" ng-if='u.avt'><img ng-src="{{u.avt}}" onerror="this.src='<?php echo $_smarty_tpl->tpl_vars['URL_IMAGES']->value;?>
/no-avatar.jpg'" alt="" width="30" height="30" class="avatar w-100 h-100 img-cover rounded-pill"></span><span class="name">{{u.name}}</span>
													</div>
												</td>
												<td class="c text-center">{{u.correct || '--'}}</td>
												<td class="st text-center"><span class="flame" ng-if="u.streak>0"><ic name="flame" color="var(--warning)"></ic>{{u.streak || '--'}}</span><span class="dash" ng-if="u.streak===0">—</span></td>
